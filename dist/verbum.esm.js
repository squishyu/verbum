...
import React__default, { createElement, useRef, useEffect, Fragment, useState, useCallback, useMemo, Suspense, lazy, useLayoutEffect, useContext, createContext } from 'react';
...
import { TextNode, DecoratorNode, $getNodeByKey, SELECTION_CHANGE_COMMAND, COMMAND_PRIORITY_HIGH, KEY_ESCAPE_COMMAND, $isNodeSelection, $getSelection, CLICK_COMMAND, COMMAND_PRIORITY_LOW as COMMAND_PRIORITY_LOW$1, KEY_DELETE_COMMAND, KEY_BACKSPACE_COMMAND, createEditor, $setSelection, $isElementNode, $isParagraphNode, $isTextNode, $createParagraphNode, $createTextNode, createCommand, $isRangeSelection, COMMAND_PRIORITY_EDITOR, REDO_COMMAND, UNDO_COMMAND, $getRoot, CLEAR_EDITOR_COMMAND, FORMAT_TEXT_COMMAND, $getNearestNodeFromDOMNode, INDENT_CONTENT_COMMAND, COMMAND_PRIORITY_CRITICAL, FOCUS_COMMAND, FORMAT_ELEMENT_COMMAND, OUTDENT_CONTENT_COMMAND, $insertNodes, $isRootOrShadowRoot, $isRootNode, DEPRECATED_$isGridSelection, CAN_UNDO_COMMAND, CAN_REDO_COMMAND } from 'lexical';
import { useLexicalComposerContext } from '@lexical/react/LexicalComposerContext';
import { mergeRegister, $wrapNodeInElement, $getNearestNodeOfType } from '@lexical/utils';
import katex from 'katex';
import { useLexicalNodeSelection } from '@lexical/react/useLexicalNodeSelection';
import { exportToSvg, Excalidraw } from '@excalidraw/excalidraw';
...
function ExcalidrawModal(_ref) {
  ...
  function ShowDiscardDialog() {
    ...
    }, t('action:Confirm_Discard'), /*#__PURE__*/createElement("div", {
    ...
    }, t('action:Discard')), ' ', /*#__PURE__*/createElement(Button, {
      onClick: () => {
        setDiscardModalOpen(false);
      }
    }, t('action:Cancel'))));
  ...
  }, discardModalOpen && /*#__PURE__*/createElement(ShowDiscardDialog, null), /*#__PURE__*/createElement(Excalidraw, {
    onChange: onChange,
    initialData: {
      appState: {
        isLoading: false
...
function ExcalidrawComponent(_ref) {
  ...
  var [editor] = useLexicalComposerContext();
  var [isModalOpen, setModalOpen] = useState(data === '[]' && editor.isEditable());
...
var Editor = _ref => {
  ...
  }, /*#__PURE__*/React__default.createElement(AutoFocusPlugin, null), /*#__PURE__*/React__default.createElement(ClearEditorPlugin, null), hashtagsEnabled && /*#__PURE__*/React__default.createElement(HashtagPlugin, null), /*#__PURE__*/React__default.createElement(KeywordsPlugin, null), /*#__PURE__*/React__default.createElement(SpeechToTextPlugin$1, null), autoLinkEnabled && /*#__PURE__*/React__default.createElement(LexicalAutoLinkPlugin, null), /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(RichTextPlugin, {
